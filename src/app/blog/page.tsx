...
export default function KarhunoBlogPage() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      summary: "We tested the Big Three against Karhuno AI on a real B2B sales query. Discover why general AI summarizing isn't enough for modern SDRs.",
      category: "Comparisons",
      readingTime: "10 min read",
      image: "/images/blog/karhuno-vs-ai-hero.png",
      slug: "karhuno-vs-popular-ai-tools"
    }
  ];
        ...
        <nav className="flex flex-wrap justify-center gap-3 mb-24 max-w-6xl mx-auto px-4">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-full border transition-all duration-200 text-sm ${montserrat.className} ${selectedCategory === cat
